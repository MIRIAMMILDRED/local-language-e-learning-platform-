...
<head>
  ...
  <title>Nuru - Create New Course</title>
                ...
                <div class="new-section">
                  <div class="form_group">
                    <form action="add_section.php" method="post">
                      ...
                      <?php } ?>
                      <input class="form_input_1" type="text" placeholder="Section title here" name="sectionadd" />
                  </div>
                </div>
              </div>
            </div>
                      ...
                      <div class="new-section mt-30">
                        <div class="form_group">
                          <form action="add_lecture.php" method="post">
                            ...
                            $query2 = "SELECT * FROM curriculum WHERE course_id = '$course_id' ORDER BY ID DESC LIMIT 1";
                            $section_info = mysqli_fetch_array(mysqli_query($conn, $query2));
                            $section_id = $section_info['ID'] ?>
                            <input class="form_input_1" type="hidden" placeholder="Title here" name="section_id" value="<?php echo $section_id; ?>" />

                            <input class="form_input_1" type="hidden" placeholder="Title here" name="type" value="lecture" />
                            <input class="form_input_1" type="text" placeholder="Title here" name="title" />
                      ...
                      <div class="new-section">
                        <div class="form_group mt-30">
                          ...
                          <input class="form_input_1" type="hidden" placeholder="Title here" name="section_id" value="<?php echo $section_id; ?>" />
                            ...
                            <input class="form_input_1" type="hidden" placeholder="Title here" name="type" value="Quiz" />
                          <input class="form_input_1" type="text" placeholder="Title here" name = "title" />
                        </div>
                      </div>
                      <div class="ui search focus lbel25 mt-30">
                    ...
                    <div class="tab-pane fade" id="nav-questions" role="tabpanel">
                      <div class="lecture-video-dt mt-30">
                        <div class="add-ques-dt">
                          <button type="button" class="main-btn color btn-hover w-100" data-toggle="collapse" data-target="#add-ques">
                            <i class="far fa-plus-square mr-2"></i>Add
                            Question
                          </button>
                            ...
                            <div class="lecture-video-dt mt-30">
                              ...
                              <div class="video-category">
                                ...
                                <label><input type="radio" name="colorRadio" value="mchoice" /><span><i class="far fa-check-circle mr-2"></i>Multiple
                                    Choice</span></label>
                                <label><input type="radio" name="colorRadio" value="sline" /><span><i class="far fa-edit mr-2"></i>Single
                                    Line Text</span></label>
                                <label><input type="radio" name="colorRadio" value="mline" /><span><i class="far fa-file-alt mr-2"></i>Milti
                                    Line Text</span></label>
                                  ...
                                  <div class="ans-box">
                                    <div class="row">
                                      <div class="col-lg-12 col-md-12">
                                        <button class="main-btn color btn-hover mt-30">
                                          Add Option
                                        </button>
                                      </div>
                                      <div class="col-lg-12 col-md-12">
                  ...
                  <div class="col-md-12">
                    <div class="curriculum-add-item">
                      <h4 class="section-title mt-0">
                        <i class="fas fa-th-list mr-2"></i>Curriculum
                      </h4>
                      <button class="main-btn color btn-hover ml-left add-section-title" data-toggle="modal" data-target="#add_section_model">
                        New Section
                      </button>
                    </div>
                    <?php
                    $course_id = $_GET['course_id'];
                    $query = mysqli_query($conn, "SELECT * FROM `curriculum` WHERE `course_id` = '$course_id'");
                    ...
                    ?>
                      ...
                      <div class="added-section-item mb-30">
                        <div class="section-header">
                          <h4>
                            <i class="fas fa-bars mr-2"></i><?php echo $row['section_name']; ?>
                          </h4>
                          <div class="section-edit-options">
                            <button class="btn-152" type="button" data-toggle="collapse" data-target="#edit-section">
                              <i class="fas fa-edit"></i>
                            </button>
                            <button class="btn-152" type="button">
                              <i class="fas fa-trash-alt"></i>
                            </button>
                          </div>
                        </div>
                        ...
                        <div class="section-group-list sortable">
                          <?php
                          $elements = mysqli_query($conn, "SELECT * FROM `curriculum_elements` WHERE `section_id` = '" . $row['ID'] . "'");

                          while ($element = mysqli_fetch_array($elements)) {
                          ...
                          ?>
                            <div class="section-list-item">
                              <div class="section-item-title">
                                ...
                                <span class="section-item-title-text"><?php echo $element['title']; ?></span>
                              </div>
                              <button type="button" class="section-item-tools">
                                <i class="fas fa-edit"></i>
                              </button>
                        ...
                        if ($section_id == $row['ID']) { ?>
                          ...
                          <div class="section-add-item-wrap p-3">
                            <button class="add_lecture" data-toggle="modal" data-target="#add_lecture_model">
                              <i class="far fa-plus-square mr-2"></i>Lecture
                            </button>
                            <button class="add_quiz" data-toggle="modal" data-target="#add_quiz_model">
                              <i class="far fa-plus-square mr-2"></i>Quiz
                            </button>
                            <button class="add_assignment" data-toggle="modal" data-target="#add_assignment_model">
                              <i class="far fa-plus-square mr-2"></i>Assignment
                            </button>
                          </div> <?php
                                }
