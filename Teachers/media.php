                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade" id="nav-video" role="tabpanel">
                                            <div class="lecture-video-dt mt-30">
                                                <span class="video-info">Select your preferred video type. (.mp4, YouTube,
                                                    Vimeo etc.)</span>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6">
                                                                <div class="upload-file-dt mt-30">
                                                                    ...
                                                                    <span class="uploaded-id color-fmt">Size: 590x300 pixels. Supports: jpg,jpeg,
                                                                        or png</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form_group mt-30">
                                                            ...
                                                            <span class="alt-text">Student have to collect this score in percent
                                        ...
                                        <div class="mp4 intro-box" style="display: block">
                                            <div class="row">
                                                <div class="col-lg-5 col-md-12">
                                                    <div class="upload-file-dt mt-30">
                                                        <div class="upload-btn">
                                                            <input class="uploadBtn-main-input" name="media" type="file" id="IntroFile__input--source" />
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5 col-md-6">
                                            ...
                                            <div class="thumb-item">
                                                ...
                                                <div class="thumb-dt">
                                                    <div class="upload-btn">
                                                        <input class="uploadBtn-main-input" type="file" id="ThumbFile__input--source" name="thumbnail"/>
                                                        <label for="ThumbFile__input--source" title="Zip">Choose Thumbnail</label>
                                                    </div>
                                                    <span class="uploadBtn-main-file">Size: 590x300 pixels. Supports: jpg,jpeg,
                                                        or png</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="ui search focus mt-30 lbel25">
                                        <div class="ui left icon input swdh19">
                                            ...
                                            <div class="step-footer step-tab-pager">
                                                <button type="submit" data-direction="prev" class="btn btn-default steps_btn" name="submit">
                                                    SUBMIT
                                                </button>
                                            </div>
