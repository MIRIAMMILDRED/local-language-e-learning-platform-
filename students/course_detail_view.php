		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<iframe src="../Teachers/uploads/<?php echo $course_info['media']; ?>" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
							...
							<div class="row justify-content-center">
								...
								<div class="col-xl-8 col-lg-7 col-md-6">
									...
									<div class="auth1lnkprce">
										<a href="register_course.php?course_id=<?php echo $course_info['ID']; ?>" class="upload_btn">Register</a>
									</div>
